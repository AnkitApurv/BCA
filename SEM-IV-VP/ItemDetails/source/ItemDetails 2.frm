...
Begin VB.Form frmItemDetails2 
   ...
   End
End
Attribute VB_Name = "frmItemDetails2"
...
Private Sub Form_Load()
 ...
 'manually making an odbc dsn is not required
 'following line makes a dsn when app starts and it is closed when app is closed
 db.Open "Driver={Microsoft Access Driver (*.mdb)}; Dbq=W:\SEM IV VP\ItemDetails\debug\ItemDetails.mdb"
End Sub
